...
LUCI_DEPENDS:=+nginx +unzip +zoneinfo-asia +php8 +php8-cgi +php8-fpm \
	+php8-mod-curl +php8-mod-fileinfo +php8-mod-filter +php8-mod-ftp \
	+php8-mod-gd +php8-mod-iconv +php8-mod-mbstring +php8-mod-mysqli \
	+php8-mod-mysqlnd +php8-mod-opcache +php8-mod-openssl +php8-mod-pdo \
	+php8-mod-pdo-mysql +php8-mod-pdo-sqlite +php8-mod-session \
	+php8-mod-sockets +php8-mod-sqlite3 +php8-mod-zip \
